<section id="title-page">
    <div class="container-fluid">
        ...
        <p id="sync">
            <a href="javascript:syncronizeBookTopDownload();" title="Syncronize top download book">
                <i id="icon-sync-book" class="icon-refresh"></i> 
                <span id="loader-sync-book" class="ajax-loader-small"></span>
                Syncronize TopDownload Books
            </a>
        </p>
        <p id="add">
            <a href="<?php echo site_url('cms/book/topdownload_add') ?>"><i class="icon-file"></i>Add Top Download</a>
        </p>
    </div>
</section>
...
<script>
    ...
    function loadItems(page){
        ...
        $.post("<?php echo site_url('ajax/cms');?>",{func:'book_get_topdownload',page:page,limit:limit},function(result){
    ...
    function syncronizeBookTopDownload(){
        //if (category_id>0){
            if (confirm('Syncronize will replace old data with new data from API. It will take some times. Are you sure ?')){
                ...
                $.post("<?php echo site_url('ajax/syncronize_book');?>",{func:'syncronize_topdownload'},function(result){
                    var data = jQuery.parseJSON(result);
