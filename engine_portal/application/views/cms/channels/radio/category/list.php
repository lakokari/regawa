<section id="title-page">
    <div class="container-fluid">
        ...
        <p id="add">
            <a href="<?php echo site_url('cms/radio/category_add') ?>"><i class="icon-file"></i>Add Category</a>
        </p>
    </div>
</section>
...
<script>
    ...
    function loadItems(radio_source, page){
        ...
        $.post("<?php echo site_url('ajax/cms');?>",{func:'radio_get_category',page:page,limit:limit},function(result){
