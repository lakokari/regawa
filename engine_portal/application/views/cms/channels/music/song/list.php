<section id="title-page">
    <div class="container-fluid">
		...
		<p>
            <?php echo btn_new('cms/music/song_edit','Add Song');?>
        </p>
    </div>
</section>
...
<script>
    ...
    function loadSongs(albumId,page){
        ...
        $.post("<?php echo site_url('ajax/cms');?>",{func:'get_song_by_album',albumId:albumId,page:page,limit:songLimit,autoSync:$('#autosync').val()},function(result){
            $('table#table-data tr.data').each(function(){$(this).remove();});            
            var data = jQuery.parseJSON(result);
