<section id="title-page">
    <div class="container-fluid">
        ...
        <p>
            <?php echo btn_new('cms/tovi/category_edit/','Add Parent Category');?>
        </p>
    </div>
</section>
...
<script>
    ...
    function loadItems(page){
        ...
        $.post("<?php echo site_url('ajax/cms');?>",{func:'tovi_get_categories',page:page,limit:limit},function(result){
