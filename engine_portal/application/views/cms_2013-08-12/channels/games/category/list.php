<section id="title-page">
    <div class="container-fluid">
        ...
        <p id="sync">
            <a href="javascript:syncronizeCategory();" title="Syncronize all categories">
        ...
        <p id="add">
            <a href="<?php echo site_url('cms/games/category_add') ?>"><i class="icon-file"></i>Add Category</a>
        </p>
    </div>
</section>
...
<script>
    ...
    function loadCategory(page){
        ...
        $.post("<?php echo site_url('ajax/cms');?>",{func:'games_get_category',page:page,limit:limit},function(result){
    ...
    function syncronizeCategory(){
        if (confirm('Syncronize will replace old data with new data from API. It will take some times. Are you sure ?')){
            ...
            $.post("<?php echo site_url('ajax/syncronize_games');?>",{func:'syncronize_category'},function(result){
                var data = jQuery.parseJSON(result);
