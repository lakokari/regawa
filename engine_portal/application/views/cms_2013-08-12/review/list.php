<section id="title-page">
    <div class="container-fluid">
        ...
        <p id="add">
            <?php echo "<a href='../add/".$channel_name."'><h3>Add</h3></a>"; ?>
        </p>
    </div>
</section>
...
<script>
    ...
    function loadCategory(page){
        ...
        $.post("<?php echo site_url('ajax/review');?>",{func:'review_get_item',channel_name:'<?php echo $channel_name;?>',page:page,limit:limit},function(result){
