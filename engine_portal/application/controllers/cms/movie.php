...
class Movie extends U_CMS_Controller {
    ...
    function items_edit($id=NULL){
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $post_fields = array(
                'categories','subcategories', 'item_name','item_description','publisher_name','published_year','synopsis','scene_writer',
        ...
        $this->load->model(array($this->channel_name.'/category',$this->channel_name.'/subcategory'));
